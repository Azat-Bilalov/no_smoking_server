    ...
    (e.unstable_scheduleCallback = function (C, P, z) {
      ...
      return (
        ...
        z > W
          ...
          : ((C.sortIndex = G), n(s, C), w || g || ((w = !0), vl(k))),
        C
      );
    }),
...
function bo(e, n, t, r) {
  if (jr) {
    ...
    else if ((Yi(e, r), n & 4 && -1 < Zc.indexOf(e))) {
      for (; l !== null; ) {
        var o = Jt(l);
        if (
          (o !== null && zs(o),
...
var it = {
  ...
  Pl = we(lf),
  of = A({}, it, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
  uf = we(of),
  sf = A({}, it, {
...
var _f = Qe && "TextEvent" in window && !xt,
  js = Qe && (!ri || (xt && 8 < xt && 11 >= xt)),
  bi = " ",
  eu = !1;
function Ds(e, n) {
  switch (e) {
...
function Vs(e) {
  if (e.propertyName === "value" && rl(It)) {
    var n = [];
    Us(n, It, e, Go(e)), ws(Lf, n);
  }
}
function Rf(e, n, t) {
  e === "focusin"
    ? (ru(), (_t = n), (It = t), _t.attachEvent("onpropertychange", Vs))
    : e === "focusout" && ru();
}
function Of(e) {
        ...
        for (var a = f, d; a !== null; ) {
          ...
          if (
            (d.tag === 5 &&
              v !== null &&
              ((d = v),
              c !== null && ((v = Mt(a, c)), v != null && S.push(Vt(a, v, d)))),
            M)
          )
            break;
          a = a.return;
...
var yo = typeof setTimeout == "function" ? setTimeout : void 0,
  ...
  Wf =
    typeof queueMicrotask == "function"
      ...
      : typeof fu < "u"
      ? function (e) {
          return fu.resolve(null).then(e).catch(Qf);
        }
      : yo;
function Qf(e) {
  setTimeout(function () {
...
function ia(e) {
  ...
  function h(c, a, d, v, k) {
    return a === null || a.tag !== 7
      ? ((a = _n(d, c.mode, v, k)), (a.return = c), a)
      : ((a = l(a, d)), (a.return = c), a);
  }
  function m(c, a, d) {
  ...
  function p(c, a, d, v) {
    ...
    if (typeof d == "object" && d !== null) {
      ...
      if (wt(d) || ct(d)) return k !== null ? null : h(c, a, d, v, null);
      pr(c, d);
    }
    return null;
  }
  function g(c, a, d, v, k) {
    ...
    if (typeof v == "object" && v !== null) {
      switch (v.$$typeof) {
        ...
        case Je:
          var x = v._init;
          return g(c, a, d, x(v._payload), k);
      }
      if (wt(v) || ct(v)) return (c = c.get(d) || null), h(a, c, v, k, null);
      pr(a, v);
    }
    return null;
  }
  function w(c, a, d, v) {
    for (
      var k = null, x = null, _ = a, N = (a = 0), H = null;
      _ !== null && N < d.length;
      N++
    ) {
    ...
    if (N === d.length) return t(c, _), U && wn(c, N), k;
    if (_ === null) {
      for (; N < d.length; N++)
        (_ = m(c, d[N], v)),
          _ !== null &&
            ((a = o(_, a, N)), x === null ? (k = _) : (x.sibling = _), (x = _));
      return U && wn(c, N), k;
    }
  ...
  function S(c, a, d, v) {
    ...
    for (
      var x = (k = null), _ = a, N = (a = 0), H = null, T = d.next();
      _ !== null && !T.done;
      N++, T = d.next()
    ) {
      _.index > N ? ((H = _), (_ = null)) : (H = _.sibling);
    ...
    if (T.done) return t(c, _), U && wn(c, N), k;
    if (_ === null) {
      for (; !T.done; N++, T = d.next())
        (T = m(c, T.value, v)),
          T !== null &&
            ((a = o(T, a, N)), x === null ? (k = T) : (x.sibling = T), (x = T));
      return U && wn(c, N), k;
    }
    ...
    if (
      ...
      switch (d.$$typeof) {
        ...
        case Fn:
          ...
          return i(c);
        case Je:
          return (x = d._init), M(c, a, x(d._payload), v);
      }
...
function Ca(e, n, t) {
  return zn & 21
    ? (Me(t, n) || ((t = Ns()), (V.lanes |= t), (Ln |= t), (e.baseState = !0)),
      n)
...
function od(e, n, t, r, l, o, i) {
  ...
  if (((u = (i & e.childLanes) !== 0), ce || u)) {
    ...
    return Pi(), (r = Al(Error(y(421)))), mr(e, n, i, r);
  }
  return l.data === "$?"
    ? ((n.flags |= 128),
      (n.child = e.child),
...
function cd(e, n) {
  ...
  for (ho = { focusedElem: e, selectionRange: t }, jr = !1, E = n; E !== null; )
...
function $a(e) {
  ...
  n !== null && ((e.alternate = null), $a(n)),
    ...
    e.tag === 5 &&
      ((n = e.stateNode),
      n !== null &&
        (delete n[De], delete n[At], delete n[go], delete n[Kf], delete n[Yf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function Ba(e, n) {
  ...
  switch (e.tag) {
    ...
    case 15:
      ...
      break;
    case 1:
      Pe(n, e), Fe(e), r & 512 && t !== null && Wn(t, t.return);
      break;
    case 5:
      if (
        (Pe(n, e),
  ...
  if (n !== 0) {
    ...
    if (n === 6) en(e, r);
      ...
      switch (((e.finishedWork = l), (e.finishedLanes = r), n)) {
        ...
        case 3:
          if (
            (en(e, r), (r & 130023424) === r && ((n = xi + 500 - Q()), 10 < n))
          ) {
            if (Fr(e, 0) !== 0) break;
            ...
            e.timeoutHandle = yo(Sn.bind(null, e, ae, Ve), n);
            break;
          }
          Sn(e, ae, Ve);
          break;
        case 4:
          ...
          if (
            ...
            e.timeoutHandle = yo(Sn.bind(null, e, ae, Ve), r);
            break;
          }
          Sn(e, ae, Ve);
          break;
...
function Sn(e, n, t) {
  var r = O,
    l = Ce.transition;
  try {
    (Ce.transition = null), (O = 1), vd(e, n, t, r);
  } finally {
    (Ce.transition = l), (O = r);
  }
  return null;
...
ys = _i;
gs = Tn;
var Nd = { usingClientEntryPoint: !1, Events: [Jt, $n, ol, hs, vs, _i] },
  yt = {
  ...
  Pd = {
    ...
    findFiberByHostInstance: yt.findFiberByHostInstance || xd,
...
const Ld = ({ onFileChange: e }) => {
    ...
    return D.jsxs("div", {
      children: [
        D.jsx("h3", { className: "head", children: "Прикрепите файл" }),
        D.jsx("input", { className: "input-form", type: "file", onChange: n }),
      ],
    });
  },
  Td = ({ onClick: e, isLoading: n }) =>
    D.jsx("button", {
      className: "button-send",
      onClick: e,
      disabled: n,
      children: n ? "Обработка..." : "Отправить",
    }),
  Rd = ({ isVideoEnabled: e, handleToggleVideo: n }) =>
    D.jsxs(D.Fragment, {
      children: [
        D.jsx("label", {
          className: "video-toggle",
          htmlFor: "video-toggle",
          children: "Получать видеопоток:",
        }),
        D.jsx("input", {
          id: "video-toggle",
          type: "checkbox",
  ...
  Od = () => {
    ...
    const g = () => {
      ...
      S = async () => {
        ...
        c.append("file", e);
        try {
          const a = await fetch(`${p}/upload-image/`, {
            method: "POST",
            body: c,
          });
          if (
            (a.headers.get("Content-type"),
            a.headers.get("Content-type") == "video/mp4")
          )
            u(!0);
          else {
            const k = a.headers.get("cigarette_exists");
            m(k && k.toLowerCase() === "true");
          }
          for (let [k, x] of a.headers) console.log(`${k}: ${x}`);
          console.log(a.headers.get("cigarette_exists")),
            console.log(a.headers.get("cigarette_exists") == "True");
          const d = await a.blob(),
    ...
    return D.jsxs("div", {
      ...
      children: [
        D.jsxs("div", {
          ...
          children: [
            D.jsx(Ld, { onFileChange: w }),
            D.jsx(Td, { onClick: S, isLoading: l }),
            D.jsx(Rd, {
              className: "toggle",
              isVideoEnabled: s,
              handleToggleVideo: M,
          ...
          (i
            ? D.jsx("div", {
                ...
                children: D.jsx("video", {
                  className: "video",
                  controls: !0,
                  children: D.jsx("source", { src: t, type: "video/mp4" }),
                }),
              })
            : D.jsxs("div", {
                ...
                children: [
                  ...
                  h
                    ? D.jsx("p", { children: "Человек курит!" })
                    : D.jsx(D.Fragment, {}),
                ],
              })),
      ],
...
function Md() {
  return D.jsx(D.Fragment, { children: D.jsx(Od, {}) });
}
Ql.createRoot(document.getElementById("root")).render(D.jsx(Md, {}));
